...
Revision ID: 5defe0891fa3
Revises: 0bff392e8f3d
Create Date: 2024-07-23 19:51:48.870468
...
revision: str = '5defe0891fa3'
down_revision: Union[str, None] = '0bff392e8f3d'
...
def downgrade() -> None:
    ...
    sa.Column('remitted_at', sa.DATETIME(), nullable=False),
    sa.Column('id', sa.INTEGER(), nullable=False),
    sa.Column('created_at', sa.DATETIME(), nullable=False),
    sa.Column('updated_at', sa.DATETIME(), nullable=False),
    sa.ForeignKeyConstraint(['vehicle_id'], ['vehicles.id'], ),
